...
const { submitFeedback, getAllFeedback, updateFeedbackStatus, submitAdminFeedback } = require('../controllers/feedbackController');
...
router.post('/admin-response', protect, restrictTo('admin'), submitAdminFeedback); // New route
